...
if ($result->num_rows > 0) {
    while ($row= $result->fetch_assoc()) {
          if (gettype(unserialize($row['checkbox']))=='array' ) {
         $test=unserialize($row['checkbox']);
...
<div class="aa-product-view-slider">                                
  <div id="demo-1" class="simpleLens-gallery-container">
    <div class="simpleLens-container">
      <div class="simpleLens-big-image-container"><a data-lens-image="img2/' . $row['image'] . '" class="simpleLens-lens-image"><img src="img/view-slider/medium/polo-shirt-1.png" class="simpleLens-big-image"></a></div>
    </div>
...
<div class="aa-product-view-content">
  ...
  <h4> Selected--Color : ' . $row['color'] . '</h4>
